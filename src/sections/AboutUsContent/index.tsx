        ...
        <div className='about-us-content__content'>
          <div className='about-us-content__description'>
            ...
            <div
              ...
              data-aos='fade-right'
            >
              <span className='about-us-content__description__title'>
                甘邻科技
              </span>

              <span className='about-us-content__description__title__subtitle'>
                是一家致力于社区物业数字化，和在线生活服务的创新型企业。我们为中小型物业公司提供终身免费的数字物业平台、居民APP，和极低成本的智能硬件。通过软件、硬件、互联网的完美融合，为物业客户增加多种经营收入，提高经营水平，提升居民服务体验。让社区生活更美好
              </span>
            </div>
          </div>
