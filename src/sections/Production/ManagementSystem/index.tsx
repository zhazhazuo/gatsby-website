...
import TabIconSmartSecurity from "@/assets/section/ManagementSystem/icon-smartSecurity.png"
import TabIconMobileWork from "@/assets/section/ManagementSystem/icon-mobileWork.png"
import TabIconPropertyService from "@/assets/section/ManagementSystem/icon-propertyService.png"
import TabIconChargeManagement from "@/assets/section/ManagementSystem/icon-chargeManagement.png"
...
const tabList: TabBlockProps["tabList"][0][] = [
  {
    ...
    icon: (
      <i
        className='management-system__tab-list__icon'
        style={{
          backgroundImage: `url(${TabIconPropertyService})`,
        }}
      />
    ),
    content: (
  ...
  },
  {
    ...
    icon: (
      <i
        className='management-system__tab-list__icon'
        style={{
          backgroundImage: `url(${TabIconChargeManagement})`,
        }}
      />
    ),
    content: (
...

  {
    ...
    icon: (
      <i
        className='management-system__tab-list__icon'
        style={{
          backgroundImage: `url(${TabIconMobileWork})`,
        }}
      />
    ),
    content: (
  ...
  },
  {
    ...
    icon: (
      <i
        className='management-system__tab-list__icon'
        style={{
          backgroundImage: `url(${TabIconSmartSecurity})`,
        }}
      />
    ),
    content: (
          ...
          >
            ...
            >
              <CustomButton
                type='primary'
                size='default'
                onClick={navigateHandle("propertyCenter")}
              >
                立即访问
              </CustomButton>
            </div>
