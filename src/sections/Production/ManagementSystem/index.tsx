      ...
      <ModuleGird
        ...
        data={[
          ...
          },
          {
            ...
            title: "物业工单",
            content:
              "住户可以在甘邻APP提交物业服务工单，物业工作人员可以在电脑和手机上，方便的进行处理和记录，已覆盖报事报修",
          },
          {
            icon: "",
            title: "通知公告",
          ...
          },
          {
            ...
            title: "小区活动",
            content:
              "物业可自助发布小区活动，住户可以通过甘邻APP报名参加。我们还提供了方便的工具和供应商资源",
          },
          {
            icon: "",
            title: "访客管理",
            content:
              "住户可以在甘邻APP上自助创建访客码，并转发给访客。所有访问记录都有据可查，更可以生成安防日志",
          },
          {
            icon: "",
            title: "先进简便的权限管理",
            content:
              "我们设计了非常健全的角色和权限系统，物业管理员可以自助管理不同角色和员工的权限",
          },
        ]}
      />
    ),
      ...
      <ModuleGird
        ...
        data={[
          ...
          },
          {
            ...
            title: "AI催缴",
            content:
              "代替人工催缴，借助APP消息、短信、自动语音电话，自动向业主催收",
          },
          {
            icon: "",
            title: "用户自助缴费",
            content:
              "借助甘邻APP，住户可以自助缴费，物业管理人员可以在后台实时看到缴费进度",
          },
          {
            icon: "",
            title: "资金极速到账",
        ...
        data={[
          {
            icon: "",
            title: "物业管理",
            content: "员工开门，服务工单，认证审核，再也不用守在电脑前才能办公",
          },
          {
            icon: "",
            title: "商家服务",
        ...
        data={[
          {
            icon: "",
            title: "门禁安装助手",
            content: "配合甘邻的门禁设备，可能是禁安装维护最简单的门禁设备",
          },
          {
            icon: "",
            title: "设备管理",
            content:
              "我们提供了非常简洁的设备管理功能，可以很方便的查看，和远程控制你的设备。同时提供了微信小程序，方便您在手机上也能管理。",
          },
          {
            icon: "",
            title: "门禁卡管理",
            content: "简单直观的完成开卡、销卡，以及查看卡片的刷卡日志",
          },
          {
            icon: "",
            title: "安防大数据",
            content:
              "我们专门研发的门禁设备，可以实时获取门禁的运行和通行记录，安全永久的存储在云端。您可以借助甘邻提供的仪报表，进一步分析小区的安防情况",
          },
          {
            icon: "",
            title: "安防日志",
            content:
              "每次刷卡，每次开门，我们都持久的在云端存储了日志，基于此我们会生成安防日志，方便在安防和治安等场景下使用，授权后也可以随时导出或数据对接",
          },
        ]}
      />
    ),
